...
const SEO_ABOUT_CONTENT = [
  ...
  },
  {
    ...
    h2: "Rated 4.6 by 400+ Guests — India's Top Boutique Stay",
    ...
    eeat: "Our 4.6 rating isn't an accident. We manage every guest interaction personally. Booking directly via our official WhatsApp ensures you bypass aggregator fees while directly speaking with the team that will host you on the mountain."
  }
];
