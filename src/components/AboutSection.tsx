...
import { Trees, Compass, UtensilsCrossed, ArrowRight } from "lucide-react";
...
export default function AboutSection({ 
  ...
  const USPList = [
    {
      title: "180° Views From ALL Rooms",
      icon: Compass,
      desc: "Gaze at Nanda Devi and Trishul snow peaks directly from your bed and private balcony. Every single room commands an unobstructed 180° mountain vista.",
    },
    {
      title: "Rich Variety of Food",
      icon: UtensilsCrossed,
      desc: "Savor a great variety of delicious homestyle meals, authentic Kumaoni delicacies, North Indian comforts, and evening bonfire barbecues.",
    },
    {
      title: "Ramgarh Fruit Hub & Peace",
      icon: Trees,
      desc: "Nestled within sweet orchards of peach, plum, and apple trees. Breathe crisp pine air in a serene sanctuary designed for pure relaxation.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-[17px] sm:text-lg text-[#2C3531]/90 font-sans leading-relaxed">
              Every detail of the resort has been designed for pure relaxation and visual connection with nature. 
              Uniquely, <strong>every single room commands an unobstructed 180° Himalayan view of Nanda Devi and Trishul</strong>. 
              Mornings feature fresh mountain breezes through pine canopies, warm tea under sunlit fruit 
              orchards, and a great variety of freshly prepared homestyle food. Cozy pine-paneled rooms and our resident fireplace 
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-[#1B3322] text-[#FAF9F6] p-6 rounded-sm shadow-xl max-w-xs border border-[#c9a832]/30 hidden sm:block">
              ...
              <p className="text-xs font-sans text-white/80 leading-relaxed">
                "The 180° Himalayan view from our bedroom, the delicious variety of food, and quiet fruit orchards made this our most relaxing mountain holiday."
              </p>
