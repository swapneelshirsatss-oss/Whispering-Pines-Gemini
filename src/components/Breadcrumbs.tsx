...
export default function Breadcrumbs() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['about', 'stay', 'amenities', 'services', 'experiences', 'booking'];
