    ...
    <header className="relative min-h-screen flex items-center justify-center bg-[#1B3322] overflow-hidden">
      ...
      >
        ...
        <div className="mt-10 flex flex-col items-center justify-center">
          <div className="inline-flex items-center gap-2.5 bg-[#1B3322]/90 backdrop-blur-md border border-[#c9a832]/60 px-6 py-3 rounded-full shadow-xl hover:border-[#c9a832] transition-colors">
            ...
            <div className="flex items-center gap-1.5 text-sm sm:text-base font-sans">
              <strong className="text-[#c9a832] font-bold text-base sm:text-lg">4.6★</strong>
              <span className="font-semibold text-white">(400+ Google Reviews)</span>
            </div>
          </div>
        </div>
      </div>
