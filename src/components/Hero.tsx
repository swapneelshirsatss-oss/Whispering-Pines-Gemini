    ...
    <header className="relative min-h-screen flex items-center justify-center bg-[#1B3322] overflow-hidden">
      ...
      >
        ...
        <div className="mt-10 flex flex-col items-center justify-center">
          <div className="inline-flex items-center gap-3 bg-[#1B3322]/90 backdrop-blur-md border border-[#c9a832]/60 px-5 py-2.5 rounded-full shadow-xl hover:border-[#c9a832] transition-colors">
            <div className="flex -space-x-2.5 overflow-hidden">
              <img className="inline-block h-7 w-7 rounded-full border-2 border-[#1B3322] object-cover" src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&q=80&w=100" alt="Happy guest"/>
              <img className="inline-block h-7 w-7 rounded-full border-2 border-[#1B3322] object-cover" src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=100" alt="Happy guest"/>
              <img className="inline-block h-7 w-7 rounded-full border-2 border-[#1B3322] object-cover" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=100" alt="Happy guest"/>
              <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#c9a832] text-[#1B3322] font-bold text-[10px]">
                4.9★
              </div>
            </div>
            <div className="flex items-center gap-1.5 text-xs sm:text-sm font-sans font-medium text-[#FAF9F6]">
              ...
              <span><strong className="text-[#c9a832] font-bold text-sm sm:text-base">4.6★</strong> <span className="font-bold text-white">(400+ Google Reviews)</span></span>
              <span className="mx-1 text-[#c9a832]">•</span>
              <span><strong className="text-[#c9a832] font-bold">4.9★</strong> <span className="text-white/90 font-medium">across platforms</span></span>
            </div>
          </div>
        </div>
      </div>
