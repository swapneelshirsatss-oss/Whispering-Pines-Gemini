...
const SEO_SERVICES_CONTENT = [
  ...
  },
  {
    ...
    eeat: "Executing mountain events requires seasoned local coordination. Our on-site hospitality team has hosted over 40 high-altitude weddings, family reunions, and executive retreats without a logistical hitch."
  },
  {
    id: "packages",
    ...
    h3s: [
      ...
      "Dedicated Event Manager for Corporate Retreats — Precision Coordination from Arrival to Departure",
