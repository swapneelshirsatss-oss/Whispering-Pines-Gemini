...
export default function WhatsAppButton() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed bottom-0 left-0 w-full z-50 md:hidden bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] border-t border-gray-200 p-3 flex items-center justify-between"
        initial={{ y: 100 }}
        animate={{ y: 0 }}
      ...
      <motion.a
        ...
        rel="noopener noreferrer"
        onClick={handleClick}
        className="fixed bottom-6 right-6 z-50 hidden md:flex items-center justify-center p-4 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300 transition-colors"
