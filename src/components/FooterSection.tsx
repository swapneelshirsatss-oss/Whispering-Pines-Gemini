        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-14 border-b border-[#FAF9F6]/10">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-xs sm:text-sm font-sans text-[#FAF9F6]/80 pt-1">
              ...
              <a href="/blog/" data-astro-prefetch="hover" className="hover:text-[#c9a832] transition-colors flex items-center gap-1.5"><span className="w-1.5 h-1.5 bg-[#c9a832] rounded-full group-hover:scale-125 transition-transform"></span>Journal</a>
